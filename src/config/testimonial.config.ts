...
export const testimonials: Testimonial[] = [
  {
    id: "t1",
    image:
      "https://res.cloudinary.com/dsperrtyj/image/upload/v1690536453/movement-guy/eldad_daxwee.webp",
    name: "אלדד מאייר",
    title: "מתאגרף, קפואריסטה, והיום תלמיד קבוע",
    text: `גיא קיבל אותי (כמו את כל שאר המתאמנים) בזרועות פתוחות וברגע אחד
      הרגשתי חלק ממשהו
      התחלנו את המסע באימונים וגיא סלל את הדרך עם המתאמנים להבנה שיש עומק לאימון והוא לא רק התרגילים שאנו מבצעים, לכל תרגיל יש את החשיבה שלו, לפני, אחרי וההסתכלות על הדרך לגשת אליו שתמיד צריכה להיות נגד עינינו!
      אין מישהו שלא מרגיש חלק, או שלא ירגיש בנוח לשאול שאלה, גיא רק מחכה לזה.. אחד הדברים שאני הכי אוהב לראות מהצד- שגיא משתוקק לשאלות מאנשים, להסביר למישהו/ מישהי שהיה לו/לה חסר פיסת מידע קטנה וקריטית על מנת להצליח/ להבין תרגיל/תנועה מסוימת והכל בגישה
      נעימה ורגועה.
      אני עדיין לא בטוח מה אנחנו עושים באימונים.. אבל אני יודע שאני זז, זז בצורה שכל הגוף שלי משתנה מתפתח ולומד, תמיד מתוך עניין וידיעה שלאן שגיא מכוון את הסירה יעשה לגוף שלי רק טוב!
      `,
  },
  {
    id: "t2",
    image:
      "https://res.cloudinary.com/dsperrtyj/image/upload/v1690536451/movement-guy/noa_e66zxa.webp",
    name: "נועה שומוביץ",
    title: "פיזיוטרפיסטית, מורה ליוגה ופילאטיס",
    text: `השיעורים עם גיא הם שילוב של כיף ועבודה עם הגוף. 
  
      האווירה נינוחה ומקבלת, יש מקום לכולם ווריאציות ברמות שונות למתאמנים מתקדמים וגם לכאלו שלגמרי רק מתחילים.
  
      בתור אחת שכבר עברה כמה וכמה מורים, עברה את גיל 30 ולא מתאמנת כל יום,  האפשרות לנשום במהלך השיעור מתקבלת בהבנה וגיא תמיד דואג למצוא אלטרנטיבה שתתאים למצב של הגוף היום. והכיף הכי גדול הוא שאני עדין מתקדמת, ורואה תוצאות`,
  },
  {
    id: "t4",
    image:
      "https://res.cloudinary.com/dsperrtyj/image/upload/v1690536453/movement-guy/Olivier-Goetgeluck_bysjgq.jpg",
  ...
  },
  {
    id: "t3",
    image:
      "https://res.cloudinary.com/dsperrtyj/image/upload/v1690536451/movement-guy/neil_m8wn9m.webp",
    name: "ניל טייסנר",
  ...
  },
  {
    id: "t5",
    image:
      "https://res.cloudinary.com/dsperrtyj/image/upload/v1690536451/movement-guy/ofer_awrmpp.webp",
    name: "עופר דוידי",
    title: "ראש הממשלה",
